        ...
        <div className="relative mx-auto max-w-screen-xl px-4 py-32 sm:px-6 lg:flex lg:h-screen lg:items-center lg:px-8">
          <div className="max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
            <h1 className="text-3xl font-extrabold sm:text-5xl">
              ZenZone
              <strong className="block font-extrabold text-teal-700"> Ledger</strong>
            </h1>

            <p className="mt-4 max-w-lg sm:text-xl/relaxed">
              Harnessing the power of Blockchain to bring transparency and efficiency to the carbon credit market. Offset your emissions with ease.
            </p>
          ...
          <div className="grid grid-cols-1 gap-y-8 lg:grid-cols-2 lg:items-center lg:gap-x-16">
            <div className="mx-auto max-w-lg text-center lg:mx-0 ltr:lg:text-left rtl:lg:text-right">
              ...
              <p className="mt-4 text-gray-600">
                "ZenZone Ledger: A Web3 startup ensuring transparent buying and selling of carbon credits, making climate action simple, secure, and effective."
              </p>
            ...
            <div className="grid grid-cols-2 gap-4 sm:grid-cols-3">
              {[
                { title: "Transparency", description: "Ensure transparent carbon credits trading using Web3 technology." },
                { title: "Simplicity", description: "Simplify carbon credits buying and selling for everyone." },
                { title: "Security", description: "Secure, verifiable carbon credits transactions through blockchain innovation." },
                { title: "Empowerment", description: "Empower climate action with transparent carbon credits platform." },
                { title: "Accessibility", description: "Make carbon offsetting easy, reliable, and accessible online." },
                { title: "Sustainability", description: "Promote sustainable practices via blockchain-based carbon credits." },
              ].map((feature, index) => (
                <Link
                  key={index}
