...
const page = () => {
  ...
  const { data: thebuyer, refetch: begin } = useReadContract({
    abi: zenzoneABI,
    address: CONTRACT_ADDRESS,
  ...
  const handleChange = (e: ChangeEvent<HTMLInputElement>) => {
    setAmount(parseInt(e.target.value, 10).toString());
  };
    ...
    <div>
      <div className="h-screen w-full flex overflow-hidden select-none">
          ...
          <ul className="mt-2 text-gray-700 dark:text-gray-400 capitalize">
            ...
            >
              <a href="#" className=" flex flex-col items-center">
                ...
                <span className="text-xs mt-2">Payments history</span>
              </a>
            </li>
          ...
          <div className="flex">
            ...
            >
              ...
              <div className="flex flex-col items-center mt-12">
                ...
                <span className="font-bold mt-8">No pending application.</span>
                  ...
                  <div className="fixed top-4 w-80 right-4 bg-white p-4 rounded-lg shadow-md mt-14">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex flex-col gap-2">
                        ...
                        <small>
                          <span className="font-italic">NB:</span> Each Carbon
                          Credit is equal to 1 cUSD
                        </small>
        ...
        >
          ...
          <span className="mt-1 text-3xl font-semibold">3.58 cUSD</span>
